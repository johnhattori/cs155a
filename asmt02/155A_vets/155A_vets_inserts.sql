...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3105, 17002, 29, '2013-08-10 9:15:00'  );
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3010, 17026, 29, '2013-08-22 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3010, 1, 104, 25.00, 'routine exam'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3001, 17027, 29, '2013-08-24 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3001, 1, 104, 25.00, 'routine exam'  );    
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3202, 17025, 29, '2013-10-03 14:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3202, 1, 341, 20.00, 'followup on parasites'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3203, 16002, 29,  '2013-10-03 14:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3203, 1, 524, 20.00, 'followup on parasites'  );    

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3282, 21001, 15, '2013-11-23 10:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3304, 17027, 15, '2013-11-06 10:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3306, 17025, 29, '2013-12-06 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3390, 19845, 15, '2013-12-22 09:00:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3392, 21003, 15, '2013-12-26 09:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3393, 16002, 29, '2013-12-23 12:15:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3393, 1, 748, 29.50, 'rat ulcer recurrence'  );    

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3409, 17027, 29, '2013-12-27 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3409, 1, 104, 25.00, 'routine exam'  );
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3486, 21005, 15, '2013-12-31 13:00:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3486, 1, 4601, 275, 'aggressive behaviour' );
	
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4101, 15001, 15, '2014-01-02 13:00:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4102, 15002, 15, '2014-01-08 13:00:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (4102,  1, 104, 60, 'reg exam' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (4103, 16002, 38, '2014-01-08 15:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (4103, 1, 4601, 275, 'aggressive behaviour' );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3104, 12035, 38, '2014-01-09 16:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3288, 15001, 25, '2014-01-09 09:00:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3322, 16002, 29, '2014-02-10 9:15:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3322, 1, 748, 29.50, 'rat ulcer recurrence'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3321, 16002, 29, '2014-02-17 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3321, 1, 748, 0.00, 'rat ulcer recurrence'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3324, 17025, 29, '2014-02-25 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3323, 16002, 29, '2014-02-25 14:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3323, 1, 524, 20.00, 'followup on parasites'  ); 
	
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3325, 17026, 29, '2014-03-15 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3325, 1, 104, 25.00, 'routine exam'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3420, 16003, 15, '2014-04-01 16:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3420, 1, 108, 80.00, 'yearly checkup'  );
 
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3494, 15001, 25, '2014-04-22 09:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3494, 1, 104, 30, 'follow up check up'  ); 
 
 insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3411, 17025, 29, '2014-04-29 14::00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3411, 1, 341, 20.00, 'followup on parasites'  );

 insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3412, 17025, 29, '2014-04-30 14:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc) 
    values (3412, 1, 341, 20.00, 'followup on parasites'  );
    
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3413, 16003, 15, '2014-05-01 16:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
    values (3413, 1, 308, 5.00, 'follow up check up'  );

insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3612, 16003, 15, '2014-05-23 08:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3513, 15401, 15, '2014-06-06 10:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3514, 15002, 29, '2014-06-10 10:45:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
...
insert into vt_exam_headers(ex_id, an_id, stf_id, ex_date)
  values (3552, 16003, 15, '2014-06-10 10:30:00'  );
  insert into vt_exam_details(ex_id, line_item, srv_id, ex_fee, ex_desc)
